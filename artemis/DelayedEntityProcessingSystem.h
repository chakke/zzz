...
namespace artemis{
   ...
   * entity, you can simply use this system to execute in a future at a time of the intest
   * lived entity, and then reset the system to run at a time in a future at a time of the
   * intest lived entity, etc.
   *
   * Another example system would be an TroopAnimationSystem. You know when you have to animate
